...
const Home = () => {
  ...
  return (
    // Overflow-x-hidden yahan add kiya hai extra side space hatane ke liye
    <div className="min-h-screen bg-slate-950 text-white selection:bg-lime-400 pt-6 selection:text-black overflow-x-hidden">
      
      {/* --- HERO SECTION --- */}
      <section className="relative min-h-[90vh] flex items-center pt-20 lg:pt-0 overflow-hidden bg-slate-950">
        {/* Background Glows */}
        ...
        <div className="container my-10 mx-auto px-6 z-10">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="flex-1 text-left">
              ...
              >
                FitAI monitors your <span className="text-white font-semibold italic underline decoration-lime-500/50">Habit Score</span> and recovery levels to dynamically adjust your training and nutrition plans every 24 hours.
              </p>
            ...
            >
              <div className="relative z-10 w-full max-w-[550px] mx-auto group">
                ...
                <div className="absolute -bottom-8 -left-4 md:-left-10 p-5 bg-slate-900/90 backdrop-blur-2xl border border-slate-700 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] animate-bounce-slow hidden sm:flex">
                  <div className="flex items-center gap-4">
                    <div className="p-3 bg-lime-500/20 rounded-xl text-lime-400">
                      <Brain size={28} />
                    </div>
                    <div>
                      <p className="text-[10px] text-slate-500 uppercase tracking-[0.2em] font-bold">Engine Status</p>
                      <p className="text-sm font-bold text-white tracking-tight">ANALYZING HABITS...</p>
                ...
                <div className="absolute -top-6 right-0 p-4 bg-blue-600/10 backdrop-blur-xl border border-blue-500/30 rounded-2xl shadow-xl hidden sm:block">
                  <div className="flex flex-col items-center gap-1">
                    <BarChart3 className="text-blue-400" size={24} />
                    <span className="text-[10px] font-bold text-blue-200">LIVE SYNC</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* --- STATS STRIP --- */}
      <div className="border-y border-slate-900 bg-slate-950/50 backdrop-blur-sm overflow-hidden">
      ...
      <section className="py-24 bg-slate-950 overflow-hidden">
        <div className="container mx-auto px-6 text-center mb-16">
          <h2 data-aos="fade-up" className="text-4xl font-bold mb-4">Engineered for Results</h2>
          <div data-aos="fade-up" className="w-20 h-1 bg-lime-500 mx-auto"></div>
        </div>

        <div className="container mx-auto px-6 grid md:grid-cols-3 gap-8">
          <div data-aos="fade-right" className="p-8 rounded-3xl bg-slate-900/50 border border-slate-800 hover:border-lime-500/50 transition-colors group">
            ...
            <p className="text-slate-400 leading-relaxed text-sm">
              Our formula $Score = (W \times 0.6) + (D \times 0.4)$ tracks your consistency and predicts drop-off risks before they happen.
            </p>
          </div>

          <div data-aos="fade-up" className="p-8 rounded-3xl bg-slate-900/50 border border-slate-800 hover:border-blue-500/50 transition-colors group">
            ...
            <p className="text-slate-400 leading-relaxed text-sm">
              Feeling fatigued? FitAI automatically adjusts your volume or swaps high-intensity moves for mobility work.
            </p>
          </div>

          <div data-aos="fade-left" className="p-8 rounded-3xl bg-slate-900/50 border border-slate-800 hover:border-purple-500/50 transition-colors group">
            ...
            <p className="text-slate-400 leading-relaxed text-sm">
              Get dynamic completion dates for your weight goals based on your actual weekly average weight change.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 overflow-hidden">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-black mb-6">Ready to outwork your old self?</h2>
            <p className="text-lg font-medium mb-10 max-w-xl mx-auto opacity-90">
              Join the 10,000+ users who have stopped guessing and started training with AI precision.
            </p>
