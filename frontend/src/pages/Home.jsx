  ...
  <div className="container mx-auto px-6 z-10">
    <div className="flex flex-col lg:flex-row items-center gap-16">
      ...
      <div className="flex-1 text-left">
        <div data-aos="fade-right" className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-900 border border-slate-800 mb-6">
          <span className="relative flex h-3 w-3">
            <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-lime-400 opacity-75"></span>
            <span className="relative inline-flex rounded-full h-3 w-3 bg-lime-500"></span>
          </span>
          <span className="text-sm font-medium text-slate-300 tracking-wide uppercase">AI Adaptive Engine Active</span>
        </div>
        
        <h1 data-aos="fade-right" data-aos-delay="100" className="text-5xl md:text-7xl font-extrabold tracking-tight mb-6 leading-[1.1]">
          Evolutionary <br />
          <span className="text-lime-400 drop-shadow-[0_0_15px_rgba(163,230,53,0.3)]">Fitness Intelligence</span>
        </h1>
        
        <p data-aos="fade-right" data-aos-delay="200" className="max-w-xl text-lg text-slate-400 mb-10 leading-relaxed">
        ...
        <div data-aos="fade-up" data-aos-delay="400" className="flex flex-col sm:flex-row items-center gap-5">
