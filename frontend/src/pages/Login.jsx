  ...
  return (
    <div className="min-h-screen bg-[#05080a] flex items-center justify-center p-4 relative overflow-hidden font-sans">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        <div className="absolute top-[-10%] left-[-10%] w-125 h-125 bg-lime-500/5 blur-[120px] rounded-full animate-pulse" />
        <div className="absolute bottom-[-10%] right-[-10%] w-125 h-125 bg-blue-500/5 blur-[120px] rounded-full animate-pulse" />
      </div>

      {/* --- LOGIN CARD --- */}
      <div
        data-aos="zoom-out-up"
        className="relative w-full max-w-112.5 bg-slate-900/40 backdrop-blur-2xl border border-white/10 rounded-[3rem] p-8 md:p-12 shadow-[0_0_50px_rgba(0,0,0,0.5)] overflow-hidden"
      >
        {/* Top Accent Line */}
          ...
          <div data-aos="fade-up" data-aos-delay="400">
            <div className="relative group">
              ...
              <div className="relative flex items-center">
                <Mail
                  className="absolute left-4 text-slate-500 group-focus-within:text-lime-400 transition-colors"
                  size={18}
                />
                <input
                  type="email"
        ...
        >
          <p className="text-[10px] text-slate-500 font-bold uppercase tracking-widest">
            ...
            <a
              href="/register"
              className="text-white hover:text-lime-400 transition-all border-b border-slate-800 hover:border-lime-400 pb-1"
            >
              Create New Identity
            </a>
          </p>
